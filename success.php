...
// PHP code to display a congratulatory message
$message = "Well Done! Payment Successful! A receipt will be sent to your email.";
?>
...
<head>
    ...
    <style>
        ...
        * {
        ...
        li:nth-child(3) { left: 25%; animation-delay: 4s; }		
        li:nth-child(4) {
            left: 40%;
            width: 60px;
            height: 60px;
