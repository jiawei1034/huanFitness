...
<body>
<form id="pricingForm" method="post" action="checkout.php">
        ...
        <ul class="pricingTable-firstTable">
          <?php foreach ($pricingPlans as $plan): ?>
              <li class="pricingTable-firstTable_table">
                  <h1 class="pricingTable-firstTable_table__header"><?= $plan['title'] ?></h1>
                  <p class="pricingTable-firstTable_table__pricing"><span>RM</span><span><?= $plan['price'] ?></span><span>/Month</span></p>
                  ...
                  <form method="post" action="checkout.php">
                      <input type="hidden" name="selected_plan" value="<?= $plan['title'] ?>">
                      <input type="hidden" name="price" value="<?= $plan['price'] ?>">
                      <input type="hidden" name="options" value="<?= implode('|', $plan['options']) ?>">
                      <button type="submit" class="pricingTable-firstTable_table__getstart">Get Started Now</button>
                  </form>
              </li>
          <?php endforeach; ?>
      </ul>
