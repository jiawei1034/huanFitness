...
if(isset($_POST['delete user']))
{
    ...
    $query = "DELETE FROM userdata WHERE id='$user_id'";
...
$query = "UPDATE users SET name='$name', email = '$email', phone='$phoneNum', address='$email' 
           WHERE id='$user_id'";
           $query_run = mysqli_query($conn, $query);
...
if(isset($_POST['add_user'])){
    ...
    $query = "INSERT INTO userdata (email,phoneNum) VALUES 
    ('$email','$phoneNum')";
