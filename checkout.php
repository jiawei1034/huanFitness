...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['selected_plan']) && isset($_POST['price'])) {
        ...
        // Prepare SQL statement for membership update
        ...
        if ($stmt->execute()) {
            ...
            $_SESSION['selected_plan'] = $selected_plan; // Store selected plan in session
            $_SESSION['price'] = $price; // Store price in session
        } else {
